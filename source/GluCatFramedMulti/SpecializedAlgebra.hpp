...
namespace gabenchmark {
    ...
    using multivector_t = framed_multi<real_t, -std::max(GABENCHMARK_GLUCAT_NEGATIVE_GENERATORS, GABENCHMARK_GLUCAT_POSITIVE_GENERATORS), std::max(GABENCHMARK_GLUCAT_NEGATIVE_GENERATORS, GABENCHMARK_GLUCAT_POSITIVE_GENERATORS)>;
