...
constexpr decltype(auto) _tbgal_MakeBladeImpl(gabm::real_t scalar_factor, gabm::factors_list_t const &vector_factors, std::index_sequence<Indices...>) noexcept {
...
GABM_DEFINE_MAKE_BLADE(scalar_factor, vector_factors, grade) {
    return _tbgal_MakeBladeImpl(scalar_factor, vector_factors, std::make_index_sequence<grade>{});
}
